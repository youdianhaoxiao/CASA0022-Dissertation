...
data1, data2, data3,data4,data5, labels = readData('./imu_DB3.csv')
                    ...
                    for m in subsample:
                        for n in colsample_bytree:
                            ...
                            if accuracy > max_accuracy:
                                ...
                                print('Datas',f'data{num}','learning_rate:', i, 'max_depth:', j, 'min_child_weight:', k, 'gamma:', l,'subsample:', m, 'colsample_bytree:', n, 'accuracy:', accuracy)
